...
|---|---|---|---|---|
| direct | 180 | 22 / 0 | +12.2 [+7.8, +17.2] | 0.0000 |
| reflexion | 180 | 4 / 9 | -2.8 [-6.7, +1.1] | 0.2668 |
| violation_reprompt | 180 | 17 / 7 | +5.6 [+0.6, +11.1] | 0.0639 |
| iter_vrp | 180 | 13 / 7 | +3.3 [-1.1, +8.3] | 0.2632 |
...
| baseline | n paired | IS wins / baseline wins (discordant) | delta (pp) [95% CI] | McNemar p |
|---|---|---|---|---|
| direct | 180 | 7 / 0 | +3.9 [+1.1, +6.7] | 0.0156 |
| reflexion | 180 | 2 / 0 | +1.1 [+0.0, +2.8] | 0.5000 |
