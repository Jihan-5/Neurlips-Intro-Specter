...
| Profile-MuSiQue × Qwen 2.5 7B | 57.1% | **81.4%** | +24.2 | 0.001 |
...
| Profile-Travel × DeepSeek V3.1 | **81.7%** | 65.7% | +16.0 | 0.022 |
...
### Profile-MuSiQue (3-hop multi-hop QA — our hardest deep-DAG benchmark)
...
Profile-MuSiQue × Gemini Flash (p = 10⁻⁵)**, achieves **100% top-1 attribution
