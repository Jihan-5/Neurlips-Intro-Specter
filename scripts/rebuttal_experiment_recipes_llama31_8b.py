#!/usr/bin/env python3
"""Recipes non-synthetic multi-fault leg, model=llama-3.1-8b (via
...
Usage:
    python3 scripts/rebuttal_experiment_recipes_llama31_8b.py --smoke --num-faults 1
    python3 scripts/rebuttal_experiment_recipes_llama31_8b.py --num-faults 1 --seeds 0,1,2 --n-examples 60
"""
...
_COMMON = _load_module("recipes_common_llama31_8b", "scripts/rebuttal_experiment_recipes_common.py")
