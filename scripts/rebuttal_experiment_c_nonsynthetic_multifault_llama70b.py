#!/usr/bin/env python3
"""Experiment C non-synthetic multi-fault leg, model=llama-3.3-70b (via
Together, NOT OpenRouter -- matches the existing repo convention, e.g.
...
Usage:
    python3 scripts/rebuttal_experiment_c_nonsynthetic_multifault_llama70b.py --smoke --num-faults 2
    python3 scripts/rebuttal_experiment_c_nonsynthetic_multifault_llama70b.py --num-faults 2 --seeds 0,1,2 --n-examples 60
"""
...
_COMMON = _load_module(
    "nonsynth_multifault_common_llama70b", "scripts/rebuttal_experiment_c_nonsynthetic_multifault_common.py"
)
