#!/usr/bin/env python3
"""Experiment C non-synthetic multi-fault leg, model=qwen-2.5-7b.
...
Usage:
    python3 scripts/rebuttal_experiment_c_nonsynthetic_multifault_qwen.py --smoke --num-faults 2
    python3 scripts/rebuttal_experiment_c_nonsynthetic_multifault_qwen.py --num-faults 2 --seeds 0,1,2 --n-examples 60
"""
...
_COMMON = _load_module(
    "nonsynth_multifault_common_qwen", "scripts/rebuttal_experiment_c_nonsynthetic_multifault_common.py"
)
